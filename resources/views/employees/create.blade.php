...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('employee.new') }}</h1>
    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">{{ __('employee.create_hint') }}</p>
</div>

<form action="{{ route('employees.store') }}" method="POST" class="form-card bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 sm:p-8">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
            ...
            <input type="text" id="matricula" name="matricula" value="{{ old('matricula') }}"
                   ...
                   placeholder="{{ __('employee.reg_placeholder') }}">
            @error('matricula')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="email" id="email" name="email" value="{{ old('email') }}"
                   ...
                   placeholder="{{ __('employee.email_placeholder') }}">
            @error('email')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" id="telefone" name="telefone" value="{{ old('telefone') }}"
                   ...
                   placeholder="{{ __('employee.phone_placeholder') }}">
            @error('telefone')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" id="departamento" name="departamento" value="{{ old('departamento') }}"
                   ...
                   placeholder="{{ __('employee.department_placeholder') }}">
            @error('departamento')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" id="centro_custo" name="centro_custo" value="{{ old('centro_custo') }}"
                   ...
                   placeholder="{{ __('employee.field.centro_custo_placeholder') }}">
            @error('centro_custo')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" id="projeto" name="projeto" value="{{ old('projeto') }}"
                   ...
                   placeholder="{{ __('employee.field.projeto_placeholder') }}">
            @error('projeto')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" id="setor" name="setor" value="{{ old('setor') }}"
                   ...
                   placeholder="{{ __('employee.field.setor_placeholder') }}">
            @error('setor')
                <p class="text-red-500 dark:text-red-400 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
