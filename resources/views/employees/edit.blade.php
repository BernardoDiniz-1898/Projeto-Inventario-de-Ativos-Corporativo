...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-1">Atualize os dados de {{ $employee->nome }}</p>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
            ...
            <select id="status" name="status" required
                ...
                <option value="afastado" {{ old('status', $employee->status) === 'afastado' ? 'selected' : '' }}>Afastado</option>
                <option value="desligado" {{ old('status', $employee->status) === 'desligado' ? 'selected' : '' }}>Desligado</option>
                <option value="ferias" {{ old('status', $employee->status) === 'ferias' ? 'selected' : '' }}>Férias</option>
            </select>
            @error('status')
                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
            @enderror
