...
<body class="login-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    <div class="floating-shape w-72 h-72 bg-blue-400 top-20 -left-20" style="animation-delay: 0s;"></div>
    <div class="floating-shape w-96 h-96 bg-purple-400 -bottom-32 -right-32" style="animation-delay: 2s;"></div>
