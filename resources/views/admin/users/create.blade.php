...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900">{{ __('user.new') }}</h1>
    <p class="text-gray-500 text-sm mt-1">{{ __('user.create_hint') }}</p>
</div>
...
<form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            <label for="password" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('user.field.password') }} *</label>
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('user.field.password_confirm') }} *</label>
