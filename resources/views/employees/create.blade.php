...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900">{{ __('employee.new') }}</h1>
    <p class="text-gray-500 text-sm mt-1">{{ __('employee.create_hint') }}</p>
</div>
...
<form action="{{ route('employees.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
            <label for="nome" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.name') }} *</label>
            <input type="text" id="nome" name="nome" value="{{ old('nome') }}" required
                   ...
                   placeholder="{{ __('employee.field.name_placeholder') }}">
            @error('nome')
        ...
        <div>
            <label for="matricula" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.matricula') }}</label>
        ...
        <div>
            <label for="email" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.email') }}</label>
        ...
        <div>
            <label for="telefone" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.telefone') }}</label>
        ...
        <div>
            <label for="departamento" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.departamento') }}</label>
        ...
        <div>
            <label for="centro_custo" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.centro_custo') }}</label>
        ...
        <div>
            <label for="projeto" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.projeto') }}</label>
        ...
        <div>
            <label for="setor" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.setor') }}</label>
        ...
        <div>
            <label for="cargo" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.cargo') }}</label>
        ...
        <div>
            <label for="status" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.status') }} *</label>
            <select id="status" name="status" required
                ...
                <option value="ativo" {{ old('status', 'ativo') === 'ativo' ? 'selected' : '' }}>{{ __('employee.status_options.ativo') }}</option>
                <option value="afastado" {{ old('status') === 'afastado' ? 'selected' : '' }}>{{ __('employee.status_options.afastado') }}</option>
                <option value="desligado" {{ old('status') === 'desligado' ? 'selected' : '' }}>{{ __('employee.status_options.desligado') }}</option>
                <option value="ferias" {{ old('status') === 'ferias' ? 'selected' : '' }}>{{ __('employee.status_options.ferias') }}</option>
            </select>
            @error('status')
                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        ...
        <div>
            <label for="data_admissao" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.data_admissao') }}</label>
        ...
        <div class="md:col-span-2 lg:col-span-3">
            <label for="observacoes" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('employee.field.observacoes') }}</label>
            <textarea id="observacoes" name="observacoes" rows="3"
                      ...
                      placeholder="{{ __('employee.field.observacoes_placeholder') }}">{{ old('observacoes') }}</textarea>
            @error('observacoes')
                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
            @enderror
        </div>
